...
#include "../../MemoryCards/playwindow.h"
...
QT_MOC_LITERAL(1, 11, 18), // "returnToMainWindow"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 12), // "toMainWindow"
QT_MOC_LITERAL(4, 44, 9), // "yesAnswer"
QT_MOC_LITERAL(5, 54, 11), // "maybeAnswer"
QT_MOC_LITERAL(6, 66, 8) // "noAnswer"

    },
    "PlayWindow\0returnToMainWindow\0\0"
    "toMainWindow\0yesAnswer\0maybeAnswer\0"
    "noAnswer"
};
...
void PlayWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->yesAnswer(); break;
        case 3: _t->maybeAnswer(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayWindow::returnToMainWindow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PlayWindow::returnToMainWindow()
{
